...
from .cl import BancoChileScraper, CencosudScraper, SantanderScraper , BancoFalabella
...
_SCRAPERS: Dict[str, Type[BaseScraper]] = {
    ...
    "cl_banco_falabella": BancoFalabella
}
...
def list_available_scrapers() -> Dict[str, str]:
    ...
    descriptions = {
        ...
        "cl_banco_falabella": "Scraper for Banco Falabella.",
    }
